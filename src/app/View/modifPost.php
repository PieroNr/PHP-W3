                    ...
                    <div class="mb-1">
                        ...
                        <?php foreach ($recipesComments as $recipeComment) { ?>
                            <form method="post" href="modifPost.php?id=<?php echo $recipes['id'] ?>">
                                ...
                                <input style="display: none;" type="text" name="idComment"
                                       value="<?php echo $recipeComment['id']; ?>">
                                <input style="display: none;" type="text" name="author_id"
                                       value="<?php echo $recipeComment['author_id']; ?>">

                                <input type="text" name="contentComment"
                                       value="<?php echo $recipeComment['content']; ?>">
                                <button class="btn btn-secondary"
                                        onclick="window.location.href = 'deleteComment.php?id=<?php echo $recipeComment['id']; ?>';">
                                    Modifier
                                </button>
